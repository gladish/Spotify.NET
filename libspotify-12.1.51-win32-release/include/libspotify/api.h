...
typedef enum sp_playlist_type {
  ...
  SP_PLAYLIST_TYPE_START_FOLDER = 1, ///< Marks a folder starting point,:0
...
typedef struct sp_subscribers {
  ...
  char *subscribers[1];  ///< Actual size is 'count'. Array of Handles to canonical usernames
} sp_subscribers;
...
/**
 * Get a Handle to a string representing the user's login username.
 *
 * @param[in]   session         Your session object
 *
 ...
 *
 * @param[in]   link       The Spotify link whose track you are interested in
 * @param[out]  offset     Handle to offset into track (in milliseconds). If the link
 ...
 *
 * @param[in]   session    Session
 * @param[in]   tracks     Array of Handle to tracks.
 ...
 *                         if you want to keep the Handle around.
 *                         If no metadata is available for the track yet, this function returns 0.
 */
 ...
 *
 * @param[in]   result          The same Handle returned by sp_albumbrowse_create()
 * @param[in]   userdata        The opaque Handle given to sp_albumbrowse_create()
 */
...
/**
 * Given an album browse object, return the Handle to its album object
 *
 * @param[in]   alb        Album browse object
 *
 * @return                 Album object
...
/**
 * Given an album browse object, return the Handle to its artist object
 *
 * @param[in]   alb        Album browse object
 *
...
/**
 * Given an album browse object, return a Handle to one of its tracks
 *
 * @param[in]   alb        Album browse object
 ...
 * similar artist data.
 *
 * @param[in]   result          The same Handle returned by sp_artistbrowse_create()
 * @param[in]   userdata        The opaque Handle given to sp_artistbrowse_create()
 */
...
/**
 * Given an artist browse object, return a Handle to its artist object
 *
 * @param[in]   arb        Artist browse object
 *
 * @return                 Artist object
 ...
 *
 * @return                    A Handle to an artist object.
 *
 * @see artist
 */
 ...
 *
 * @return                Handle to an image object. To free the object, use
 *                        sp_image_release()
 *
 * @see sp_album_cover
 ...
 *                        fetched.
 * @param[in]  userdata   Opaque Handle passed to \p callback
 *
 */
...
*
* @return                Handle to raw image data
*/
 ...
 *
 * @param[in]   result          The same Handle returned by sp_search_create()
 * @param[in]   userdata        The opaque Handle given to sp_search_create()
 */
 ...
 * @param[in]  userdata   Opaque Handle passed to \p callback
 *
 * @return                Handle to a search object. To free the object, use sp_search_release()
 */
...
typedef struct sp_playlist_callbacks {
   ...
   * @param[in]  tracks     Array of Handles to track objects
...
/**
 * Return a Handle to the user for the given playlist
 *
 * @param[in]  playlist   Playlist object
 *
 * @return                User object
 ...
 *
 * @param[in]  playlist       Playlist object
 * @param[in]  tracks         Array of Handle to track indices.
 ...
 *
 * @param[in]  playlist       Playlist object
 * @param[in]  tracks         Array of Handle to track indices to be moved.
 *                            A certain track index should be present at most once, e.g. [0, 1, 2] is valid indata,
 *                            whereas [0, 1, 1] is invalid.
 * @param[in]  num_tracks     Length of \p tracks array
...
/**
 * Return a Handle to the playlist at a specific index
 *
 * @param[in]  pc        Playlist container
 ...
 * @param[in]  buffer       Handle to char[] where to store folder name
 ...
 *
 * @return               Handle to the new playlist. Can be NULL if the operation fails.
 */
 ...
 *
 * @return               Handle to the new playlist. Will be NULL if the playlist already exists.
 */
...
/**
 * Return a Handle to the user object of the owner.
 *
 * @param[in]  pc   Playlist container.
 ...
 * @param[in]  pc         Playlist container.
 * @param[in]  playlist   Playlist object.
 * @param[out] tracks     Array of Handle to new tracks (maybe NULL)
...
/**
 * Get a Handle to a string representing the user's canonical username.
 *
...
/**
 * Get a Handle to a string representing the user's displayable username.
 ...
 *
 * @param[in]   result          The same Handle returned by sp_toplistbrowse_create()
 * @param[in]   userdata        The opaque Handle given to sp_toplistbrowse_create()
 */
